...
public class RemoteControlCompetition {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        ProductionRemoteControlCar prc5 = new ProductionRemoteControlCar();
        ProductionRemoteControlCar prc6 = new ProductionRemoteControlCar();
        prc1.setNumberOfVictories(0);
        prc2.setNumberOfVictories(3);
        prc3.setNumberOfVictories(5);
        prc4.setNumberOfVictories(7);
        prc5.setNumberOfVictories(2);
        prc6.setNumberOfVictories(1);
        ...
        unsortedCars.add(prc5);
        unsortedCars.add(prc6);
